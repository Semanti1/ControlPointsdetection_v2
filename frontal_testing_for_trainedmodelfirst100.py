...
data_transform = transforms.Compose([#Rescale(225),
                                     ...
                                     Normalize(),
                                     ToTensor()])
transformed_dataset = FacialKeypointsDataset(csv_file=r'C:\Users\Semanti Basu\Documents\OneDrive_2020-02-19\3D Ceaser dataset\Image and point generation\Image and point generation\frontalpoints_random_test.csv',
...
def visualize_output(test_images, test_outputs, gt_pts=None, onlyfoot=None, batch_size=10):
