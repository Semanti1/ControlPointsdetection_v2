...
net1 = Net()
net1.load_state_dict(torch.load(r'C:\Users\Semanti Basu\Documents\OneDrive_2020-02-19\3D Ceaser dataset\Image and point generation\Image and point generation\profiletrained_fc3_lr0001_100epochs_first100.pth'))
...
data_transform = transforms.Compose([#Rescale(225),
                                     ...
                                     Normalize(),
                                     ToTensor()])
transformed_dataset = FacialKeypointsDataset(csv_file=r'C:\Users\Semanti Basu\Documents\OneDrive_2020-02-19\3D Ceaser dataset\Image and point generation\Image and point generation\sideviewpoints_testing_last700.csv',#side_corresp2frontal_test.csv',
...
def net_sample_output():
    ...
    for i, sample in enumerate(test_loader):
        ...
        visualize_output(images, output_pts, sample['name'], key_pts)
        #print(output_pts)
        #print(sample['name'])
...
with open("test_write_to_csv_profile_last700.csv", "w", newline='') as f:
    writer = csv.writer(f)
    net_sample_output()