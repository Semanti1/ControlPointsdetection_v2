...
net1 = Net()
net1.load_state_dict(torch.load(r'C:\Users\Semanti Basu\Documents\OneDrive_2020-02-19\3D Ceaser dataset\Image and point generation\Image and point generation\frontaltrainedmodel_resized429_fc512_lr0001_100epoch.pth'))
...
def visualize_output(test_images, test_outputs, name, gt_pts=None, onlyfoot=None, batch_size=10):
